...
export async function onRequestPost(context) {
  ...
  try {
    ...
    try {
      ...
      return new Response(JSON.stringify({ success: true, message: 'Transaction submitted successfully', txHash: cancelTx.hash, wallet, refundAmount: pendingMint.deposit.toString(), refundEth: ethers.formatEther(pendingMint.deposit) }), { status: 200, headers: { "Content-Type": "application/json" } });
    } catch (cancelError) {
