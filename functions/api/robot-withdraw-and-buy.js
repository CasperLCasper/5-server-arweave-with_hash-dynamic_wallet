...
export async function onRequestPost(context) {
  ...
  try {
    ...
    console.log('🤖 Withdraw robot: calling withdraw()...');
    ...
    // 2. Webhook robots — pērk kredītus no storage maka
    ...
    if (storageBalance > ethers.parseEther("0.00001")) {
      console.log(`🤖 Webhook robot: buying credits for ${ethers.formatEther(storageBalance)} ETH...`);
